...
namespace Domain.UseCase.Common
{
     ...
     public class ManageEventsUseCase : IManageEventsUseCase
    {
        ...
        /// <returns></returns>
        public void ConsoleProcessLog(string eventName, string id, dynamic data, bool writeData = false,
            [CallerMemberName] string callerMemberName = null)
        {
            _logger.LogInformation("ClassName: {eventName} - MethodName: {callerMemberName} - Id: {id}", eventName,
                callerMemberName, id);
